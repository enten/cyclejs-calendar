...
function main(_ref) {
  ...
  var calendarProps$ = _rx.Observable.of({
    year: 1998, month: 6
  });

  var calendar = (0, _2['default'])({ DOM: DOM, props$: calendarProps$ });

  return {
    DOM: _rx.Observable.combineLatest(calendar.DOM, calendar.value$, function (calendarVTree, value) {
      return (0, _cycleDom.div)([(0, _cycleDom.div)(value ? value.toString() : 'Pick a date'), calendarVTree]);
    })
  };
}
...
},{"../..":2,"@cycle/core":3,"@cycle/dom":4,"rx":27}],2:[function(require,module,exports){
'use strict';
...
},{"@cycle/dom":4,"@cycle/isolate":11,"calendar":15,"lodash":23,"rx":27}],3:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":6,"./render-dom":7,"./render-html":8,"./virtual-hyperscript":10,"hyperscript-helpers":19,"virtual-dom/virtual-hyperscript/svg":53}],5:[function(require,module,exports){
"use strict";
...
},{"./fromevent":5,"./transposition":9,"./virtual-hyperscript":10,"matches-selector":25,"rx":27,"vdom-parser":32,"virtual-dom/diff":39,"virtual-dom/patch":40}],8:[function(require,module,exports){
"use strict";
...
},{"rx":27,"virtual-dom/vnode/vnode":61}],10:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
},{"./property-config":37,"escape-html":16}],36:[function(require,module,exports){
var escape = require('escape-html');
...
},{"../vnode/is-vhook.js":56,"is-object":22}],42:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":54,"../vnode/is-vnode.js":57,"../vnode/is-vtext.js":58,"../vnode/is-widget.js":59,"./apply-properties":41,"global/document":18}],43:[function(require,module,exports){
...
},{"./create-element":42,"./dom-index":43,"./patch-op":44,"global/document":18,"x-is-array":66}],46:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":17}],49:[function(require,module,exports){
'use strict';
